...
import com.bonuswallet.app.ui.BaseActivity;
import com.bonuswallet.app.widget.AWalletBottomNavigationView;
...
public class BaseNavigationActivity extends BaseActivity implements AWalletBottomNavigationView.OnBottomNavigationItemSelectedListener {
    ...
    {
        nav.changeVerifyToCollect();
    }

    public void changeCollectToVerify()
    {
        nav.changeCollectToVerify();
    }
