...
import static com.bonuswallet.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
...
import com.bonuswallet.app.util.StyledStringBuilder;
...
import com.bonuswallet.app.walletconnect.WCClient;
import com.bonuswallet.app.walletconnect.WCSession;
import com.bonuswallet.app.walletconnect.entity.WCEthereumSignMessage;
import com.bonuswallet.app.walletconnect.entity.WCEthereumTransaction;
import com.bonuswallet.app.walletconnect.entity.WCPeerMeta;
import com.bonuswallet.app.walletconnect.entity.WalletConnectCallback;
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, long chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.bonuswallet.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
