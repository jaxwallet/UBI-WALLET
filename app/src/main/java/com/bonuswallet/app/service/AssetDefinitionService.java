...
import com.bonuswallet.app.entity.tokens.ERC721Token;
import com.bonuswallet.app.entity.tokens.Token;
import com.bonuswallet.app.entity.tokens.TokenFactory;
import com.bonuswallet.app.entity.tokenscript.EventUtils;
import com.bonuswallet.app.entity.tokenscript.TokenScriptFile;
import com.bonuswallet.app.entity.tokenscript.TokenscriptFunction;
...
import com.bonuswallet.app.repository.entity.RealmCertificateData;
import com.bonuswallet.app.repository.entity.RealmTokenScriptData;
...
import com.bonuswallet.token.entity.Attribute;
import com.bonuswallet.token.entity.AttributeInterface;
import com.bonuswallet.token.entity.ContractAddress;
import com.bonuswallet.token.entity.ContractInfo;
import com.bonuswallet.token.entity.EvaluateSelection;
import com.bonuswallet.token.entity.EventDefinition;
import com.bonuswallet.token.entity.FunctionDefinition;
import com.bonuswallet.token.entity.MethodArg;
import com.bonuswallet.token.entity.ParseResult;
import com.bonuswallet.token.entity.SigReturnType;
import com.bonuswallet.token.entity.TSAction;
import com.bonuswallet.token.entity.TSSelection;
import com.bonuswallet.token.entity.TokenScriptResult;
import com.bonuswallet.token.entity.TokenscriptContext;
import com.bonuswallet.token.entity.TokenscriptElement;
import com.bonuswallet.token.entity.TransactionResult;
...
import static com.bonuswallet.app.repository.TokenRepository.getWeb3jService;
import static com.bonuswallet.app.repository.TokensRealmSource.IMAGES_DB;
import static com.bonuswallet.token.tools.TokenDefinition.TOKENSCRIPT_CURRENT_SCHEMA;
import static com.bonuswallet.token.tools.TokenDefinition.TOKENSCRIPT_REPO_SERVER;
    ...
    private String processLogs(EventDefinition ev, List<EthLog.LogResult> logs, String walletAddress)
    {
        ...
        for (int i = index; i >= 0; i--)
        {
            ...
            else
            {
                ...
                com.bonuswallet.app.entity.Transaction tx = transactionRespository.fetchCachedTransaction(walletAddress, txHash);
